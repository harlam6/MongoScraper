...
app.get("/scrape", function(req, res) {
  ...
  request("http://www.crunchyroll.com/news", function(error, response, html) {
  ...
  res.send("Scrape Complete, please go back and refresh your page");
});

app.get("/save", function(req, res) {
  res.send(public/save.html);
});
